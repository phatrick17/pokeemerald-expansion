...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar Shadow
    ...
    [TYPE_SHADOW]   = {______, X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), ______, X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(2.0), X(0.5)},
};
...
const struct TypeInfo gTypesInfo[NUMBER_OF_MON_TYPES] =
{
    ...
    [TYPE_SHADOW] =
    {
        ...
        .palette = 15, // Reuses TYPE_MYSTERY's "???" icon palette
        .teraTypeRGBValue = RGB_BLACK,
        .damageCategory = DAMAGE_CATEGORY_PHYSICAL,
        .paletteTMHM = gItemIconPalette_NormalTMHM, // failsafe
        .useSecondTypeIconPalette = FALSE,
        .isSpecialCaseType = TRUE,
