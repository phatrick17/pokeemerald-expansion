...
const u16 gObjectEventPal_PlayerAccessories[] = INCBIN_U16("graphics/object_events/palettes/player_accessories.gbapal");
...
const u16 gObjectEventPal_AquaMemberM[] = INCBIN_U16("graphics/object_events/palettes/teamsnagem.gbapal");
